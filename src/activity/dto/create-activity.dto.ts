...
export class CreateActivityDto {
  ...
  @IsNotEmpty({ message: 'The step_id field cannot be empty.' })
  @IsNumber({}, { message: 'The step_id filed must be a number.' })
  step_id: number;
  ...
  @IsNotEmpty({ message: 'The item field cannot be empty.' })
  @IsString({ message: 'The item filed must be a string.' })
  item: string;
